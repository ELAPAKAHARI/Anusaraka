 ...
 sed -n '1h;2,$H;${g;s/\n/\n;~~~~~~~~~~\n/g;p}'< $1/tmp/$2_tmp/$3_rasp_cons_tmp |sed 's/($ /(POS /g' >$1/tmp/$2_tmp/$3_rasp_cons
 $HOME_anu_test/Anu_src/split_file.out $1/tmp/$2_tmp/$3_rasp_cons $1/tmp/$2_tmp/dir_names.txt rasp_constituents
