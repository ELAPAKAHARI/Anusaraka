...
for i in f:
        ...
        if  count == 3 and i == "\n":
             fp4.write(";~~~~~~~~~~\n")
        if count == 1 and (i.startswith("pcomp(") or i.startswith("prep(") or i.startswith("pobj(") or i.startswith("mwe(") or i.startswith("prt(") or i.startswith("possessive(") or i.startswith("cc") ) and i != '\n':
#        if count == 1 and  i != "\n":
             fp2.write(i)
        if count == 2 and  i != "\n":
             fp3.write(i)
