./handling_abbrevations.out  < $2/tmp/$1_tmp/one_sentence_per_line.txt.std.penn_tmp1 > $2/tmp/$1_tmp/one_sentence_per_line.txt.std.penn_tmp2
$HOME_anu_test/Anu_src/identify-nonascii-chars.out $2/tmp/$1_tmp/one_sentence_per_line.txt.std.penn_tmp2 $2/tmp/$1_tmp/one_sentence_per_line.txt.std.penn
