 ...
 (if (eq ?lwg_type MAIN_VERB) then
 (printout fp "<td class=\""?chnk_fr_htm"\"> "?l_punc ?man_op ?r_punc" </td>" crlf "</tr>" crlf)
 else (if (eq ?lwg_type AUX_VERB) then
 (printout fp "<td class=\""?chnk_fr_htm"\"> "?l_punc ?man_op ?r_punc " </td>" crlf "</tr>" crlf)
 else
 (printout fp "<td class=\""?chnk_fr_htm"\"> "?l_punc ?man_op ?r_punc " </td>" crlf "</tr>" crlf)))
